...
import com.example.arjun.easy2buy.vendor.VendorProfileActivity;
...
public class AdminProfile extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        type =findViewById(R.id.username1);
        type.setText("Username");
        ...
        logOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new PrefManager(AdminProfile.this).logout();
                FirebaseAuth firebaseAuth = FirebaseAuth.getInstance();
                firebaseAuth.signOut();
                Intent intent = new Intent(AdminProfile.this,SignInActivity.class);
        ...
        mRef.child(userid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                email.setText(eMail);
                Picasso.with(AdminProfile.this).load(image).into(dp);
        ...
        if(resultCode==RESULT_OK && requestCode==Gallery_intent && data !=null){
            ...
            storageReference.putFile(uri).addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(AdminProfile.this, "Uploaded", Toast.LENGTH_SHORT).show();
...
//                                  tvSuccess.setText(img.toString());
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(AdminProfile.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void setImage() {
        ...
        storageRefere.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                Toast.makeText(AdminProfile.this,userImg,Toast.LENGTH_SHORT).show();
                Picasso.with(AdminProfile.this).load(url).into(dp);
